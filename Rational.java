...
// Rational Monsters - Isaac Jon and Xinyi Huang
// APCS1 p8
...
public class Rational implements Comparable
{
  ...
  public boolean equals( Object other )
  {
	...
	return _numerator == ((Rational)other)._numerator && _denominator == ((Rational)other)._denominator;
    }
    return false;
  }//end equals()
  ...
  public static void main( String[] args )
  {
    /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      Rational j = new Rational(4, 8);
      Object k = new Object();
      Rational l = new Rational(3, 4);
      Rational m = new Rational(1, 4);
      ...
      System.out.println(i.compareTo(l)); //-2
      System.out.println(i.compareTo(m)); //2
      //System.out.println(i.compareTo(k)); //Compile Time Error
      System.out.println("-------------------");
